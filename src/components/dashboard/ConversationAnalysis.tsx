...
export const ConversationAnalysis = ({ data, loading, selectedRemotejid }: ConversationAnalysisProps) => {
  ...
  const getLeadNumber = (remotejid: string | null): string => {
    if (!remotejid) return "-";
                  ...
                  <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                    ...
                    <DialogContent className="max-w-4xl h-[80vh] flex flex-col">
                      <DialogHeader className="flex-shrink-0">
                        <DialogTitle>
                          Análise Completa - '{getLeadName(selectedLead?.remotejid || lead.remotejid)}'
                        </DialogTitle>
                      </DialogHeader>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="grid grid-cols-2 gap-2 text-sm">
                            <div>
                              ...
                              <span className="font-medium">{getLeadName(selectedLead?.remotejid || lead.remotejid)}</span>
                            </div>
                            <div>
                              <span className="text-muted-foreground">Telefone:</span>{" "}
                              <span className="font-medium">{getLeadNumber(selectedLead?.remotejid || lead.remotejid)}</span>
                            </div>
                            <div>
